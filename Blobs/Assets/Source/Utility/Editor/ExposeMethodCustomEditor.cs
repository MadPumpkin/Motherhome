...
// http://c.atch.co/invoke-a-method-right-from-a-unity-inspector/
...
namespace Legend
{
    ...
    public class ExposeMethodCustomEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            //Debug.Log("ExposeMethodCustomEditor");
            ...
            foreach (var method in type.GetMethods(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance))
            {
                ...
                if (attributes.Length > 0)
                {
                    ...
                    if (GUILayout.Button("Run: " + method.Name))
                    {
                        ...
                        //target.GetType().GetMethod(method.N)
